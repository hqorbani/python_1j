...
def check_traingle(side_1 , side_2 , side_3 ):
...
def Environment_triangle(side_1 , side_2 , side_3 ) :
    if check_traingle(side_1 , side_2 , side_3) == True:
        Environment = round(side_1 + side_2 + side_3)
        print(f"Environment for side_1 {side_1} and side_2 {side_2} and side_3 {side_3}  is: " , Environment)
    else:
        print("invalide data for triangle")
